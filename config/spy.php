...
return array(
	...
	'command' => 'java -jar ' . base_path('database/schemaSpy/schemaSpy_5.0.0.jar'),
	...
	*/
	...
	'parameters' => [
		'-t'  => 'mysql',
		'-dp' => base_path('database/schemaSpy/mysql-connector-java-5.1.40-bin.jar'), // download from http://dev.mysql.com/downloads/connector/j/
		'-hq' => null,
	],
);
